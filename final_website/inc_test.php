...
//checkTime();
 ...
 countdown();
  ...
  <form name='formname' action="./result.php" method="post">
<?php
...
<?php
$dbc=mysqli_connect("localhost","root","","register");$query =("SELECT m_id, t_complete FROM `exam` WHERE m_id= '" . $_SESSION['user_id'] . "' ");

...
if(isset($_POST['submit2']))
	{
		...
		$sql = mysql_query("INSERT INTO extc(Question,answer1,answer2,answer3,answer4,correct) VALUES('$question','$answer1','$answer2','$answer3','$answer4','$correct')");
		}
...
?>
 ...
 <input type="submit" name="submit" value="Submit">
  ...
  <form action="extc_new.php" method="post"
...
<input type="submit" name="submit2" value="Submit"></center>
 ...
 mysql_query("INSERT extc SET Question='$q',  answer1='$a',  answer2='$b',  answer3='$c',  answer4='$d', correct='$correct'")
 or die(mysql_error()); 

...
$q = mysql_real_escape_string(htmlspecialchars($_POST['Question']));
 ...
 mysql_query("UPDATE mech SET Question='$q',  answer1='$a',  answer2='$b',  answer3='$c',  answer4='$d', correct='$correct' WHERE Q_no='$id'")
 or die(mysql_error()); 
 ...
 // query db
 $id = $_GET['Q_no'];
 $result = mysql_query("SELECT * FROM mech WHERE Q_no=$id")
 or die(mysql_error()); 

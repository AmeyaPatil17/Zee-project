...
$q = mysql_real_escape_string(htmlspecialchars($_POST['Question']));
 ...
 mysql_query("UPDATE ce SET Question='$q',  answer1='$a',  answer2='$b',  answer3='$c',  answer4='$d', correct='$correct' WHERE Q_no='$id'")
 or die(mysql_error()); 
 ...
 // query db
 $id = $_GET['Q_no'];
 $result = mysql_query("SELECT * FROM ce WHERE Q_no=$id")
 or die(mysql_error()); 

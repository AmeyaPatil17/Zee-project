...
<p> <table  width = "75%"  border="0" align ="default">
	<tr><td>&nbsp;&nbsp;&nbsp;</td></tr>
				...
				<tr><td></td></tr>
				<tr><td></td></tr>
				<tr  ><td  colspan ="3" align ="center" ><font face = "georgia" size ="4" color= "blue"><b>Your score is:  $score out of 20</b></font></td></tr>
				<tr><td></td></tr>
				<tr><td></td></tr>
				<tr><td></td></tr>
	</table>
...
EOT;
if($total<3){
	echo'<img src="images/1.png" width="780" height="80">';
	echo'<center>Your score is POOR.You have to study more.</center>';
	}
	else if($total==3 || $total==4){
			echo'<img src="images/2.png" width="780" height="80">';
			echo'<center>Your score is LOW.You have to study little bit more.</center>';

	}
		else if($total==5 || $total==6){
			echo'<img src="images/3.png" width="780" height="80">';
			echo'<center>Your score is LOW.You have to study little bit more.</center>';

	}
		else if($total==7 || $total==8){
			echo'<img src="images/4.png" width="780" height="80">';
			echo'<center>Your score is LOW.You have to study little bit more.</center>';

	}
	else if($total==9 || $total==10){
			echo'<img src="images/5.png" width="780" height="80">';
			echo'<center>Your score is AVERAGE.Your performance is satisfactory .</center>';

	}
	else if($total==11 || $total==12){
			echo'<img src="images/6.png" width="780" height="80">';
			echo'<center>Your score is AVERAGE.Your performance is satisfactory .</center>';

	}
	else if($total==13 || $total==14){
			echo'<img src="images/7.png" width="780" height="80">';
			echo'<center>Your score is HIGH.Your performance is above satisfactory .</center>';

	}
	else if($total==15 || $total==16){
			echo'<img src="images/8.png" width="780" height="80">';
			echo'<center>Your score is HIGH.Your performance is above satisfactory .</center>';
	}
	else if($total==17 || $total==18){
			echo'<img src="images/9.png" width="780" height="80">';
			echo'<center>Your score is HIGH.Your performance is above satisfactory .</center>';

	}
	else if($total==19 || $total==20){
			echo'<img src="images/10.png" width="780" height="80">';
			echo'<center>well done Your score is VERY HIGH. Your performance is excellent .</center>';

	}
	else{
		echo'Slove more practice tests';
	}

  ...
  <div id="wrapper">
        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                ...
                <a href="http://dev7studios.com"><img src="images/up.jpg" data-thumb="images/up.jpg" alt=""  /></a>
...
<?php
  ...
  if (isset($_SESSION['username'])) {
	...
	echo '<p>&nbsp;</p>';
	echo '<p>&nbsp;</p>';
	echo  '<p>Make your self prepared by giving our <a href="practice.php"><strong>Practice test</strong></a>.
  The more you practice your skills, the more prepared and confident you’ll be on test day</p>';
  echo '<p>&nbsp;</p>';
  echo '<p>&nbsp;</p>';
  
  	echo'<center> <img src="onlineExam.png" width="200" height="124"></center>';
  echo'<span style="text-align:center;"> <p> Give the unique apptitude test </p>';
  echo'<p><a href="test selection.php"><img src="start_test.gif" width="186" height="79"/></a></p></span>';

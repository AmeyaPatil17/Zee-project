...
$query = "UPDATE exam SET tt_complete = '$state' WHERE m_id = '" . $_SESSION['user_id'] . "'";        mysqli_query($dbc, $query);
...
EOT;
    ...
    foreach($answers as $question => $answer){
         $query = mysql_query("SELECT correct FROM ".$branch." where Q_no = $question");
...
<p> <table  width = "75%"  border="0" align ="default">
	<tr><td>&nbsp;&nbsp;&nbsp;</td></tr>
				...
				<tr><td></td></tr>
				<tr><td></td></tr>
				<tr  ><td  colspan ="3" align ="center" ><font face = "georgia" size ="4" color= "blue"><b>Your score is:  $score out of 60</b></font></td></tr>
				<tr><td></td></tr>
				<tr><td></td></tr>
				<tr><td></td></tr>
	</table>
